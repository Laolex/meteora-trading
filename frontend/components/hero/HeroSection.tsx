...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* slow ambient float wrapping the parallax card */}
      <motion.div
        animate={{ y: [0, -10, 0] }}
      ...
      >
        <motion.div
          className="text-center rounded-[36px] border border-[rgba(20,241,149,0.1)] bg-[linear-gradient(180deg,rgba(23,28,35,0.76)_0%,rgba(23,28,35,0.58)_100%)] backdrop-blur-[4px] px-6 md:px-10 py-10 md:py-14"
