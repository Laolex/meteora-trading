...
export default async function DashboardPage() {
  ...
  const pnlWeekSign = kpi.pnlWeekUsd >= 0 ? "+" : ""
      ...
      <div className="grid gap-6 lg:grid-cols-[280px,1fr] items-start">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
            ...
            <KpiCard label="PnL (today)" value={`${pnlSign}${fmt(kpi.pnlDayUsd)}`} sub={`week: ${pnlWeekSign}${fmt(kpi.pnlWeekUsd)}`} accent={kpi.pnlDayUsd >= 0} index={3} />
          </div>
